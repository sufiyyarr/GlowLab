      ...
      <div class="breadcrumbs">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active current">Pigmentation Laser Treatment</li>
          </ol>
        </nav>
      </div>

      <div class="title-wrapper">
        <h1>Pigmentation Laser Treatment</h1>
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-image">
              <img src="assets/img/health/laser.webp" alt="laser Services" class="img-fluid">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="service-content">
              <h2>Pigmentation Laser Treatment</h2>
              <p class="service-tagline">Precision pigment correction and advanced skin tone leveling</p>

              <p>Our Pigmentation Laser Treatment is a sophisticated medical-aesthetic procedure designed to target and break down excess melanin in the skin. Utilizing advanced light-based technology, the treatment precisely addresses sunspots, age spots, and uneven skin patches without damaging the surrounding tissue. This process triggers the body’s natural healing response to clear away pigmented cells, resulting in a significantly more uniform complexion</p>

              <p>This treatment is ideal for individuals seeking to correct long-term sun damage or stubborn hyperpigmentation that topical treatments cannot reach. Our specialists operate with high clinical standards to ensure maximum safety and efficacy. By focusing on the deeper layers of the skin, we provide a high-performance solution for those looking to achieve a clear, spot-free, and rejuvenated skin appearance</p>

              <div class="service-features">
                <h4>Our Services Include:</h4>
                <ul>
                  <li><i class="bi bi-check-circle"></i> Digital Pigment Mapping</li>
                  <li><i class="bi bi-check-circle"></i> Targeted Laser Therapy</li>
                  <li><i class="bi bi-check-circle"></i> Post-Laser Cooling & Recovery</li>
                </ul>
              </div>
            </div>
          </div>
