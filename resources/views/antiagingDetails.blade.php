      ...
      <div class="breadcrumbs">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active current">Anti-Aging Treatment</li>
          </ol>
        </nav>
      </div>

      <div class="title-wrapper">
        <h1>Anti-Aging Treatment</h1>
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-image">
              <img src="assets/img/health/aging.webp" alt="aging" class="img-fluid">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="service-content">
              ...
              <p class="service-tagline">Structural rejuvenation and cellular renewal therapy</p>

              <p>Our Anti-Aging Treatment is an advanced restorative procedure designed to target the visible signs of aging by stimulating the skin’s natural regenerative processes. We utilize high-concentration active ingredients and non-invasive lifting techniques to improve skin elasticity, restore lost volume, and significantly reduce the appearance of fine lines and wrinkles</p>

              <p>This treatment is ideal for individuals looking to address skin laxity, dullness, or environmental damage. Our clinical approach focuses on strengthening the skin’s underlying structure and boosting moisture retention at a deeper level. By combining scientific expertise with premium care, we provide a comprehensive solution that leaves the skin feeling firmer, smoother, and visibly more youthful</p>

              <div class="service-features">
                <h4>Our Services Include:</h4>
                <ul>
                  <li><i class="bi bi-check-circle"></i> Collagen & Elastin Stimulation</li>
                  <li><i class="bi bi-check-circle"></i> Dermal Hydration Infusion</li>
                  <li><i class="bi bi-check-circle"></i> Contouring Facial Massage</li>
                </ul>
              </div>
            </div>
          </div>
