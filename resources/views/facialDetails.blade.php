      ...
      <div class="breadcrumbs">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active current">Basic Facial Treatment</li>
          </ol>
        </nav>
      </div>

      <div class="title-wrapper">
        <h1>Basic Facial Treatment</h1>
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-image">
              <img src="assets/img/health/clean.webp" alt="Basic Facial Treatment" class="img-fluid">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="service-content">
              <h2>Basic Facial Treatment</h2>
              <p class="service-tagline">Professional skin rejuvenation with advanced techniques and clinical expertise</p>

              <p>Our Basic Facial Treatment is a foundational treatment designed to deeply purify and revitalize your skin using high-performance professional products. We focus on restoring your skin’s natural equilibrium through a systematic process that effectively clears impurities while maintaining long-lasting hydration and a healthy glow</p>

              <p>This treatment is suitable for all skin types and is performed by our qualified aesthetic specialists in a controlled, clinical environment. Whether you are looking to detoxify your pores from daily environmental stressors or establish a consistent professional maintenance routine, our specialists provide personalized care tailored to your specific skin concerns and goals</p>

              <div class="service-features">
                <h4>Our Services Include:</h4>
                <ul>
                  <li><i class="bi bi-check-circle"></i> Detailed Skin Consultation</li>
                  <li><i class="bi bi-check-circle"></i> Deep Pore Cleansing & Exfoliation</li>
                  <li><i class="bi bi-check-circle"></i> Hydrating Mask & Nutrient Infusion</li>
                </ul>
              </div>
            </div>
          </div>
