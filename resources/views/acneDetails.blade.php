      ...
      <div class="breadcrumbs">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active current">Acne Solutions Treatment</li>
          </ol>
        </nav>
      </div>

      <div class="title-wrapper">
        <h1>Acne Solutions Treatment</h1>
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-image">
              <img src="assets/img/health/basic.webp" alt="acne" class="img-fluid">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="service-content">
              <h2>Acne Solutions Treatment</h2>
              <p class="service-tagline">Targeted blemish control and advanced inflammatory skin repair</p>

              <p>Our Acne Solutions Treatment is a clinical-grade procedure specifically engineered to combat active breakouts, regulate excess oil production, and accelerate the healing of post-acne marks. We utilize high-potency active ingredients and specialized extraction techniques to purify the skin at a cellular level, preventing future congestion and improving overall skin clarity</p>

              <p>This treatment is ideal for individuals experiencing persistent acne, oily skin, or inflammatory redness. Our specialists follow a rigorous clinical protocol to ensure that every step—from deep detoxification to soothing repair—is performed with precision and care. By focusing on the root causes of skin congestion, we help you achieve a smoother, more balanced complexion with visible long-term results</p>

              <div class="service-features">
                <h4>Our Services Include:</h4>
                <ul>
                  <li><i class="bi bi-check-circle"></i> Clinical Pore Detoxification</li>
                  <li><i class="bi bi-check-circle"></i> Precision Manual Extraction</li>
                  <li><i class="bi bi-check-circle"></i> Anti-Inflammatory Sebum Control</li>
                </ul>
              </div>
            </div>
          </div>
