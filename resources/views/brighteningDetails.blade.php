      ...
      <div class="breadcrumbs">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active current">Brightening Treatment</li>
          </ol>
        </nav>
      </div>

      <div class="title-wrapper">
        <h1>Brightening Treatment</h1>
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-image">
              <img src="assets/img/health/brightening.webp" alt="brightening" class="img-fluid">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="service-content">
              <h2>Brightening Treatment</h2>
              <p class="service-tagline">Advanced pigment correction and radiance enhancement</p>

              <p>Our Brightening Treatment is a high-performance solution designed to target hyperpigmentation, uneven skin tone, and dullness at their source. By utilizing concentrated Vitamin C infusions and gentle resurfacing agents, this treatment works to inhibit melanin overproduction and accelerate the removal of surface discoloration, revealing a more luminous and uniform complexion</p>

              <p>This procedure is highly recommended for individuals looking to address sun damage, dark spots, or a tired appearance. Our specialists focus on restoring the skin’s natural clarity and protecting it from future oxidative stress. The result is a visibly brighter, revitalized skin surface that feels smoother and looks significantly more radiant</p>

              <div class="service-features">
                <h4>Our Services Include:</h4>
                <ul>
                  <li><i class="bi bi-check-circle"></i> Melanin Suppression Therapy</li>
                  <li><i class="bi bi-check-circle"></i> Vitamin C & Antioxidant Infusion</li>
                  <li><i class="bi bi-check-circle"></i> Radiance Resurfacing</li>
                </ul>
              </div>
            </div>
          </div>
